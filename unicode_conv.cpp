...
bool roku::unicode::ConvChU8ToU16(const std::array<char, 4> &u8Ch,
...
bool roku::unicode::ConvChU8ToU32(const std::array<char, 4> &u8Ch, char32_t &u32Ch) {
...
bool roku::unicode::ConvChU16ToU8(const std::array<char16_t, 2> &u16Ch,
...
bool roku::unicode::ConvChU16ToU32(const std::array<char16_t, 2> &u16Ch, char32_t &u32Ch) {
...
bool roku::unicode::ConvChU32ToU8(const char32_t u32Ch, std::array<char, 4> &u8Ch) {
    if (u32Ch > 0x10FFFF) {
        return false;
    }
...
bool roku::unicode::ConvChU32ToU16(const char32_t u32Ch, std::array<char16_t, 2> &u16Ch) {
    if (u32Ch > 0x10FFFF) {
        return false;
    }
...
bool roku::unicode::ConvU8ToU16(const std::string &u8Str, std::u16string &u16Str) {
...
bool roku::unicode::ConvU8ToU32(const std::string &u8Str, std::u32string &u32Str) {
    for (auto u8It = u8Str.begin(); u8It != u8Str.end(); ++u8It) {
        auto numBytes = GetU8ByteCount((*u8It));
        if (numBytes == 0) {
            return false;
...
bool roku::unicode::ConvU16ToU8(const std::u16string &u16Str, std::string &u8Str) {
...
bool roku::unicode::ConvU16ToU32(const std::u16string &u16Str, std::u32string &u32Str) {
    for (auto u16It = u16Str.begin(); u16It != u16Str.end(); ++u16It) {
        std::array<char16_t, 2> u16Ch;
        if (IsU16HighSurrogate((*u16It))) {
            u16Ch[0] = (*u16It);
...
bool roku::unicode::ConvU32ToU8(const std::u32string &u32Str, std::string &u8Str) {
...
bool roku::unicode::ConvU32ToU16(const std::u32string &u32Str, std::u16string &u16Str) {
    for (auto u32It = u32Str.begin(); u32It != u32Str.end(); ++u32It) {
        std::array<char16_t, 2> u16Ch;
